"""PyTorch Lightning module for Transformer++ in the CL pipeline.

Wraps :class:`TransformerPPBackbone` into the standard CL pipeline interface.
...
class TransformerPPLitModule(ACPredictorLossMixin, L.LightningModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Build backbone
        self.model = TransformerPPBackbone(
            input_dim=input_dim,
            d_model=d_model,
    ...
    def on_test_epoch_end(self) -> None:
        ...
        print("\n" + "=" * 70)
        print("            TRANSFORMER++ TEST RESULTS SUMMARY")
        print("=" * 70)
