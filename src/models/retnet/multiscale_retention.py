...
#
# Adapted from torchscale/component/multiscale_retention.py
# Changes: removed MultiwayWrapper (multiway=False), uses local RMSNorm.
...
class MultiScaleRetention(nn.Module):
    def __init__(
        ...
        self.group_norm = RMSNorm(self.head_dim, eps=layernorm_eps, elementwise_affine=False)
