...
#
# Copied from temp/standard_comparison_architectures/GatedDeltaNet/lit_gpt/gated_delta_net.py
# Only change: import path for gated_delta_rule_ops updated to local package.
