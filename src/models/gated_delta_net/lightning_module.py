"""PyTorch Lightning module for GatedDeltaNet in the CL pipeline.

Wraps :class:`GatedDeltaNetBackbone` into the standard CL pipeline interface.
...
class GatedDeltaNetLitModule(ACPredictorLossMixin, L.LightningModule):
    """PyTorch Lightning module for GatedDeltaNet model.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Build backbone
        self.model = GatedDeltaNetBackbone(
            input_dim=input_dim,
    ...
    def on_test_epoch_end(self) -> None:
        ...
        print("\n" + "=" * 70)
        print("            GATED DELTA NET TEST RESULTS SUMMARY")
        print("=" * 70)
